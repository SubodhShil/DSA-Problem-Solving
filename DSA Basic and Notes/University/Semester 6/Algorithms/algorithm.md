...
| Iteration | Condition | Total iterations | Explanation|
| --- | --- | --- | --- |
| i = 0 | i <= 10 | 12 | Starts from 0 stops in when i become 11, and 0 to 11 is total 12 numbers. |
| i = 0 | i < 10  | 11 | Starts from 0 and condition says < 10 means stop at 9, 0 to 9 is total 10 numbers and one extra iteration to condition fail the loop |
